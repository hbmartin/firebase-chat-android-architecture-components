...
import me.haroldmartin.chat.api.GithubService;
import me.haroldmartin.chat.api.RepoSearchResponse;
import me.haroldmartin.chat.db.GithubDb;
import me.haroldmartin.chat.db.RepoDao;
import me.haroldmartin.chat.util.TestUtil;
import me.haroldmartin.chat.vo.ChatMessage;
import me.haroldmartin.chat.vo.Conversation;
...
public class FetchNextSearchPageTaskTest {
    ...
    public void nextPageWithNull() throws IOException {
        ...
        result.setTotal(10);
        List<ChatMessage> repos = TestUtil.createRepos(10, "a", "b", "c");
    ...
    private void createDbResult(Integer nextPage) {
        Conversation result = new Conversation("foo", Collections.emptyList(),
                0, nextPage);
    ...
    private Call<RepoSearchResponse> createCall(RepoSearchResponse body, Integer nextPage)
        ...
        Headers headers = nextPage == null ? null : Headers
                .of("link",
                        "<https://api.github.com/inbox/repositories?q=foo&page=" + nextPage
                                + ">; rel=\"next\"");
