...
public class NextPageHandlerTest {
    ...
    private InboxViewModel.NextPageHandler pageHandler;
    ...
    public void init() {
        ...
        pageHandler = new InboxViewModel.NextPageHandler(repository);
    }

    @Test
    public void constructor() {
        InboxViewModel.LoadMoreState initial = getStatus();
    ...
    private InboxViewModel.LoadMoreState getStatus() {
