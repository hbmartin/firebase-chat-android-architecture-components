...
public class ApiResponseTest {
    ...
    @Test
    public void link() {
        String link = "<https://api.github.com/inbox/repositories?q=foo&page=2>; rel=\"next\","
    ...
    public void badPageNumber() {
        String link = "<https://api.github.com/inbox/repositories?q=foo&page=dsa>; rel=\"next\"";
        okhttp3.Headers headers = okhttp3.Headers.of("link", link);
        ApiResponse<String> response = new ApiResponse<>(Response.success("foo", headers));
    ...
    public void badLinkHeader() {
        String link = "<https://api.github.com/inbox/repositories?q=foo&page=dsa>; relx=\"next\"";
        okhttp3.Headers headers = okhttp3.Headers.of("link", link);
        ApiResponse<String> response = new ApiResponse<>(Response.success("foo", headers));
        assertThat(response.getNextPage(), nullValue());
    }
