...
import me.haroldmartin.chat.util.LiveDataCallAdapterFactory;
import me.haroldmartin.chat.vo.*;
...
import static me.haroldmartin.chat.util.LiveDataTestUtil.getValue;
...
public class GithubServiceTest {
    ...
    public void getRepos() throws IOException, InterruptedException {
        ...
        List<me.haroldmartin.chat.vo.ChatMessage> repos = getValue(service.getRepos("yigit")).body;
    ...
    public void search() throws IOException, InterruptedException {
        String header = "<https://api.github.com/inbox/repositories?q=foo&page=2>; rel=\"next\","
                + " <https://api.github.com/inbox/repositories?q=foo&page=34>; rel=\"last\"";
        Map<String, String> headers = new HashMap<>();
        headers.put("link", header);
        enqueueResponse("inbox.json", headers);
        ...
        assertThat(response.links.get("next"),
                is("https://api.github.com/inbox/repositories?q=foo&page=2"));
